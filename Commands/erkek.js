...
module.exports.run = async(client, message, args) => {
    ...
    if(member.user.username.includes(config.tag)) {
        ...
        member.roles.add(congif.erkekRolleri)
    ...
    db.add(`yt.${message.author.id}.erkek`, +1);
...
${member} kişisi başarıyla <@&${config.erkek}> olarak kayıt edildi.
